# Incorporating estimands into meta-analyses of clinical trials: Code

### Antonio Remiro-Azócar, Estimands Implementation Working Group sub-team in HTA and RWE
### *aazw@novonordisk.com*
### *2025*

This repository contains the R code used for my paper [Incorporating estimands into meta-analyses of clinical trials][1], co-authored with the [Estimands Implementation Working Group sub-team in HTA and RWE][2]. 
